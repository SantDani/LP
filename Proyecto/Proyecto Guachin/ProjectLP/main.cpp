...
int main()
{
	...
	try
	{
		unsigned t0, t1;
		t0 = clock();
		string nomFitxer45 = "Xarxa1.txt";
		MatriuSparse m45(nomFitxer45);
		//m45.setVal(0, 2, 7);
		//m45.setVal(8, 1, 8);
		//float valor2;
		//bool trobat2 = m45.getVal(0, 0, valor2);
		//trobat2 = m45.getVal(8, 1, valor2);
		vector<float> vSubEpiOrdenat4;
		vSubEpiOrdenat4.resize(m45.getNFiles()+1, 1);
		vector<float> v2SubEpiOrdenat3 = m45*vSubEpiOrdenat4;
