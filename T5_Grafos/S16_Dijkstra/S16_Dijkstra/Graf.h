...
public:
	...
	int minDistance(vector<int>& dist, vector<bool>& visitat);
	void camiMesCurt(string nodeInicial, string nodeFinal, stack<string>& cami);
	void dijstraModificat(int nodeInicial, int nodeFinal, vector<int>& dist, vector<int>& anterior);
